...
public abstract class lr_parser {
     ...
     * Simple constructor. 
     */
    public lr_parser(String tables) {
      unpackStrings(tables);
    }
    
    /** 
     * Constructor that sets the default scanner. [CSA/davidm] 
     */
    public lr_parser(Scanner s, String tables) {
        this(s,new DefaultSymbolFactory(), tables); // TUM 20060327 old cup v10 Symbols as default
    }
    /** 
     * Constructor that sets the default scanner and a SymbolFactory
     */
    public lr_parser(Scanner s, SymbolFactory symfac, String tables) {
        this(tables); // in case default constructor someday does something
      ...
      for (_done_parsing = false; !_done_parsing; )
	{
	  ...
	  /* if its less than zero, then it encodes a reduce action */
	  else if (act < 0)
	    {
	      ...
	      lhs_sym = do_action(act, this, stack, stack.size()-1);
  ...
  private void unpackStrings(String s)
    {
      ...
      s = s.substring(reduce_table.length+3);
    }
}
