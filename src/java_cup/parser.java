...
/** CUP v0.12joho 20081115 generated parser.
  * @version Sun Nov 16 00:31:53 CET 2008
  */
...
RESULT = start_val;
          ...
          case 1: // spec ::= package_spec import_list code_parts symbol_list precedence_list start_spec production_list 
            {
              Grammar RESULT = null;
 RESULT = grammar; 
              return parser.getSymbolFactory().newSymbol("spec", 32, CUP$stack.elementAt(CUP$size - 7), CUP$stack.peek(), RESULT);
            }
          ...
          case 2: // spec ::= error symbol_list precedence_list start_spec production_list 
            {
              Grammar RESULT = null;
 RESULT = grammar; 
              return parser.getSymbolFactory().newSymbol("spec", 32, CUP$stack.elementAt(CUP$size - 5), CUP$stack.peek(), RESULT);
            }
	  ...
	  parser.emit.import_list.add(id.toString());
              ...
              return parser.getSymbolFactory().newSymbol("import_spec", 16, CUP$stack.elementAt(CUP$size - 3), CUP$stack.peek());
            }
 ...
 parser.main.setOption(opt, val); 
	  ...
	  if (parser.emit.parser_code!=null)
	    ...
	    parser.emit.parser_code = user_code;
              ...
              return parser.getSymbolFactory().newSymbol("parser_code_part", 12, CUP$stack.elementAt(CUP$size - 4), CUP$stack.peek());
            }
	  ...
	  if (parser.emit.init_code!=null)
	    ...
	    parser.emit.init_code = user_code;
              ...
              return parser.getSymbolFactory().newSymbol("init_code", 17, CUP$stack.elementAt(CUP$size - 4), CUP$stack.peek());
            }
	  ...
	  if (parser.emit.scan_code!=null)
	    ...
	    parser.emit.scan_code = user_code;
              ...
              return parser.getSymbolFactory().newSymbol("scan_code", 18, CUP$stack.elementAt(CUP$size - 4), CUP$stack.peek());
            }

          /*. . . . . . . . . . . . . . . . . . . .*/
          case 27: // symbol_list ::= symbol_list symbol 
            {
              return parser.getSymbolFactory().newSymbol("symbol_list", 13, CUP$stack.elementAt(CUP$size - 2), CUP$stack.peek());
            }
          ...
          case 28: // symbol_list ::= symbol 
            {
              java_cup.runtime.Symbol CUP$sym = CUP$stack.peek();
              return parser.getSymbolFactory().newSymbol("symbol_list", 13, CUP$sym, CUP$sym);
            }
 ...
 _cur_symbol_type = null; 
              return parser.getSymbolFactory().newSymbol("symbol", 19, CUP$stack.elementAt(CUP$size - 5), CUP$stack.peek());
            }
 ...
 _cur_symbol_type = id.toString(); 
              return parser.getSymbolFactory().newSymbol("NT$0", 47, CUP$stack.elementAt(CUP$size - 2), id$);
            }
          ...
          case 31: // symbol ::= TERMINAL decl_term_list SEMI 
            {
 _cur_symbol_type = null; 
              return parser.getSymbolFactory().newSymbol("symbol", 19, CUP$stack.elementAt(CUP$size - 3), CUP$stack.peek());
            }
          ...
          case 33: // NT$1 ::= 
            {
              ...
              StringBuilder id = (StringBuilder) id$.value;
 _cur_symbol_type = id.toString(); 
              return parser.getSymbolFactory().newSymbol("NT$1", 48, CUP$stack.elementAt(CUP$size - 2), id$);
            }
 ...
 _cur_symbol_type = null; 
          ...
          case 37: // decl_term_list ::= decl_term_list COMMA new_term_id 
            {
              return parser.getSymbolFactory().newSymbol("decl_term_list", 20, CUP$stack.elementAt(CUP$size - 3), CUP$stack.peek());
            }
          ...
          case 38: // decl_term_list ::= new_term_id 
            {
              java_cup.runtime.Symbol CUP$sym = CUP$stack.peek();
              return parser.getSymbolFactory().newSymbol("decl_term_list", 20, CUP$sym, CUP$sym);
            }

          /*. . . . . . . . . . . . . . . . . . . .*/
          case 39: // decl_non_term_list ::= decl_non_term_list COMMA new_non_term_id 
            {
              return parser.getSymbolFactory().newSymbol("decl_non_term_list", 21, CUP$stack.elementAt(CUP$size - 3), CUP$stack.peek());
            }
          ...
          case 40: // decl_non_term_list ::= new_non_term_id 
            {
              java_cup.runtime.Symbol CUP$sym = CUP$stack.peek();
              return parser.getSymbolFactory().newSymbol("decl_non_term_list", 21, CUP$sym, CUP$sym);
            }

          /*. . . . . . . . . . . . . . . . . . . .*/
          case 41: // precedence_list ::= precedence_list preced 
            {
              return parser.getSymbolFactory().newSymbol("precedence_list", 27, CUP$stack.elementAt(CUP$size - 2), CUP$stack.peek());
            }
          ...
          case 42: // precedence_list ::= 
            {
              java_cup.runtime.Symbol CUP$sym = CUP$stack.peek();
              return parser.getSymbolFactory().newSymbol("precedence_list", 27, CUP$sym, CUP$sym);
            }

          /*. . . . . . . . . . . . . . . . . . . .*/
          case 43: // preced ::= PRECEDENCE assoc precterminal_list SEMI 
            {
              return parser.getSymbolFactory().newSymbol("preced", 28, CUP$stack.elementAt(CUP$size - 4), CUP$stack.peek());
            }
 ...
 update_precedence(assoc.left); 
              java_cup.runtime.Symbol CUP$sym = CUP$stack.peek();
              return parser.getSymbolFactory().newSymbol("assoc", 29, CUP$sym, CUP$sym);
            }
 ...
 update_precedence(assoc.nonassoc); 
          ...
          case 47: // precterminal_list ::= precterminal_list COMMA precterminal_id 
            {
              return parser.getSymbolFactory().newSymbol("precterminal_list", 30, CUP$stack.elementAt(CUP$size - 3), CUP$stack.peek());
            }
          ...
          case 48: // precterminal_list ::= precterminal_id 
            {
              java_cup.runtime.Symbol CUP$sym = CUP$stack.peek();
              return parser.getSymbolFactory().newSymbol("precterminal_list", 30, CUP$sym, CUP$sym);
            }
	  ...
	  term.set_precedence(_cur_side, _cur_prec);
              ...
              return parser.getSymbolFactory().newSymbol("precterminal_id", 31, term$, term$);
            }
 ...
 RESULT = get_term(sym); 
              return parser.getSymbolFactory().newSymbol("term_id", 43, sym$, sym$, RESULT);
            }
 ...
 non_terminal nt = get_nonterm(start_name);
	   if (nt != null) 
	     grammar.set_start_symbol(nt); 
              ...
              return parser.getSymbolFactory().newSymbol("start_spec", 14, CUP$stack.elementAt(CUP$size - 4), CUP$stack.peek());
            }
          ...
          case 52: // start_spec ::= 
            {
              java_cup.runtime.Symbol CUP$sym = CUP$stack.peek();
              return parser.getSymbolFactory().newSymbol("start_spec", 14, CUP$sym, CUP$sym);
            }

          /*. . . . . . . . . . . . . . . . . . . .*/
          case 53: // production_list ::= production_list production 
            {
              return parser.getSymbolFactory().newSymbol("production_list", 15, CUP$stack.elementAt(CUP$size - 2), CUP$stack.peek());
            }
          ...
          case 54: // production_list ::= production 
            {
              java_cup.runtime.Symbol CUP$sym = CUP$stack.peek();
              return parser.getSymbolFactory().newSymbol("production_list", 15, CUP$sym, CUP$sym);
            }
          ...
          case 55: // production ::= symbol_id NT$2 COLON_COLON_EQUALS rhs_list SEMI 
            {
              ...
              return parser.getSymbolFactory().newSymbol("production", 22, lhs_id$, CUP$stack.peek());
            }
	  ...
	  lhs_nt = get_nonterm(lhs_id);
              ...
              return parser.getSymbolFactory().newSymbol("NT$2", 49, lhs_id$, lhs_id$);
            }

          /*. . . . . . . . . . . . . . . . . . . .*/
          case 57: // production ::= error SEMI 
            {
              return parser.getSymbolFactory().newSymbol("production", 22, CUP$stack.elementAt(CUP$size - 2), CUP$stack.peek());
            }

          /*. . . . . . . . . . . . . . . . . . . .*/
          case 58: // rhs_list ::= rhs_list BAR rhs 
            {
              return parser.getSymbolFactory().newSymbol("rhs_list", 25, CUP$stack.elementAt(CUP$size - 3), CUP$stack.peek());
            }
          ...
          case 60: // prod_precedence ::= PERCENT_PREC term_id 
            {
              ...
              terminal term = (terminal) term$.value;
 RESULT = term; 
              return parser.getSymbolFactory().newSymbol("prod_precedence", 46, CUP$stack.elementAt(CUP$size - 2), term$, RESULT);
            }
 ...
 RESULT = null; 
              java_cup.runtime.Symbol CUP$sym = CUP$stack.peek();
              return parser.getSymbolFactory().newSymbol("prod_precedence", 46, CUP$sym, CUP$sym, RESULT);
            }
 ...
 RESULT = list; if (prod != null) RESULT.add(prod); 
              return parser.getSymbolFactory().newSymbol("prod_part_list", 45, list$, prod$, RESULT);
            }
 ...
 RESULT = new ArrayList<production_part>(); 
              java_cup.runtime.Symbol CUP$sym = CUP$stack.peek();
              return parser.getSymbolFactory().newSymbol("prod_part_list", 45, CUP$sym, CUP$sym, RESULT);
            }
	  ...
	  if (symb == null)
	  ...
	  else
	    {
	      ...
	      RESULT = new symbol_part(symb, labid);
              ...
              return parser.getSymbolFactory().newSymbol("prod_part", 44, symid$, labid$, RESULT);
            }
	  ...
	  RESULT = new action_part(code_str);
              ...
              return parser.getSymbolFactory().newSymbol("prod_part", 44, code_str$, code_str$, RESULT);
            }
          ...
          case 67: // opt_label ::= COLON label_id 
            {
              ...
              String labid = (String) labid$.value;
 RESULT = labid; 
              return parser.getSymbolFactory().newSymbol("opt_label", 35, CUP$stack.elementAt(CUP$size - 2), labid$, RESULT);
            }
 ...
 RESULT = null; 
              java_cup.runtime.Symbol CUP$sym = CUP$stack.peek();
              return parser.getSymbolFactory().newSymbol("opt_label", 35, CUP$sym, CUP$sym, RESULT);
            }
 ...
 id.append('.').append(another_id); RESULT=id; 
              return parser.getSymbolFactory().newSymbol("multipart_id", 40, id$, another_id$, RESULT);
            }
 ...
 RESULT = new StringBuilder(an_id); 
              return parser.getSymbolFactory().newSymbol("multipart_id", 40, an_id$, an_id$, RESULT);
            }
          ...
          case 78: // import_id ::= multipart_id DOT STAR 
            {
              ...
              StringBuilder id = (StringBuilder) id$.value;
 id.append(".*"); RESULT = id; 
              return parser.getSymbolFactory().newSymbol("import_id", 41, id$, CUP$stack.peek(), RESULT);
            }
          ...
          case 79: // import_id ::= multipart_id 
            {
              ...
              StringBuilder id = (StringBuilder) id$.value;
 RESULT = id; 
              return parser.getSymbolFactory().newSymbol("import_id", 41, id$, id$, RESULT);
            }
          ...
          case 80: // type_id ::= multipart_id 
            {
              ...
              StringBuilder id = (StringBuilder) id$.value;
 RESULT = id; 
              return parser.getSymbolFactory().newSymbol("type_id", 42, id$, id$, RESULT);
            }
          ...
          case 81: // type_id ::= type_id LBRACK RBRACK 
            {
              ...
              StringBuilder id = (StringBuilder) id$.value;
 id.append("[]"); RESULT = id; 
              return parser.getSymbolFactory().newSymbol("type_id", 42, id$, CUP$stack.peek(), RESULT);
            }
 ...
 id.append('<').append(types).append('>');
	  ...
	  if (symbols.get(term_id) != null)
	    ...
	    {
	      /* build the terminal and put it in the symbol table */
	      terminal term = grammar.add_terminal(term_id, _cur_symbol_type);
	      symbols.put(term_id, term);
	    }
	
              return parser.getSymbolFactory().newSymbol("new_term_id", 23, term_id$, term_id$);
            }
	  ...
	  if (symbols.get(non_term_id) != null)
	  ...
	  else
	    {
	      ...
	      symbols.put(non_term_id, this_nt);
              ...
              return parser.getSymbolFactory().newSymbol("new_non_term_id", 24, non_term_id$, non_term_id$);
            }
 ...
 RESULT = the_id; 
              return parser.getSymbolFactory().newSymbol("symbol_id", 33, the_id$, the_id$, RESULT);
            }
 ...
 RESULT = "option"; 
              java_cup.runtime.Symbol CUP$sym = CUP$stack.peek();
              return parser.getSymbolFactory().newSymbol("symbol_id", 33, CUP$sym, CUP$sym, RESULT);
            }
          ...
          case 89: // label_id ::= robust_id 
            {
              ...
              String the_id = (String) the_id$.value;
 RESULT = the_id; 
              return parser.getSymbolFactory().newSymbol("label_id", 34, the_id$, the_id$, RESULT);
            }
          ...
          case 90: // robust_id ::= ID 
            {
              ...
              String the_id = (String) the_id$.value;
 RESULT = the_id; 
              return parser.getSymbolFactory().newSymbol("robust_id", 36, the_id$, the_id$, RESULT);
            }
 ...
 RESULT = "option"; 
              java_cup.runtime.Symbol CUP$sym = CUP$stack.peek();
              return parser.getSymbolFactory().newSymbol("robust_id", 36, CUP$sym, CUP$sym, RESULT);
            }
 ...
 RESULT = "nonassoc"; 
		...
		RESULT="ILLEGAL";
          ...
          case 107: // non_terminal ::= NON TERMINAL 
            {
              return parser.getSymbolFactory().newSymbol("non_terminal", 11, CUP$stack.elementAt(CUP$size - 2), CUP$stack.peek());
            }
          ...
          case 108: // non_terminal ::= NONTERMINAL 
            {
              java_cup.runtime.Symbol CUP$sym = CUP$stack.peek();
              return parser.getSymbolFactory().newSymbol("non_terminal", 11, CUP$sym, CUP$sym);
            }
